...
The defining function of PAPO–Heatwaves is the translation of institutional heat emergency policy into personalized,
 feasible micro-opportunities under real-world constraints. This logic operates continuously across simulation time steps
  and applies to both pre-heatwave and during-heatwave phases.
Different simulation paradigms (agent-based, system dynamics, discrete-event, hybrid) may operationalize this logic differently,
 but the translation sequence must be preserved.
